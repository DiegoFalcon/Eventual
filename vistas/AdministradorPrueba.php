	...
	<body>
		...
		<div class="container" style="margin-top:100px;">
			<div class="row">
				...
				<div class="row">
				<div class="col-md-2" align="left" id="listaOpcionesEventos">
    
    	    <a href="#" class="list-group-item active" style="background:#4DB6AC;"><span class="badge">14</span>Todos los Eventos</a>
      		<a href="#" class="list-group-item" style="color:white;"> <span class="badge">14</span>Eventos Pasados</a>
        	<a href="#" class="list-group-item" style="color:white;"> <span class="badge">14</span>Eventos Presentes</a>
        	<a href="#" class="list-group-item" style="color:white;"> <span class="badge">14</span>Eventos Futuros</a>
		...
		<script>
			...
			function refrescarTodosLosEventos(){
				...
				$.ajax({
				  ...
				  refrescarTablaOpciones();
				});
			}
			function refrescarTablaOpciones(){
				$.ajax({
				  type: "POST",
				  url: "../controladores/peticiones.php",
				  ...
				  for(var i=0;i<obj.Items.length;i++){
					html+='<a href="#" class="list-group-item active" style="background:#4DB6AC;"><span class="badge">'+obj.Items[i].Todos+'</span>Todos los Eventos</a>';
      				html+='<a href="#" class="list-group-item" style="color:white;"> <span class="badge">'+obj.Items[i].Presentes+'</span>Eventos Presentes</a>';
        			html+='<a href="#" class="list-group-item" style="color:white;"> <span class="badge">'+obj.Items[i].Pasados+'</span>Eventos Pasados</a>';
        			html+='<a href="#" class="list-group-item" style="color:white;"> <span class="badge">'+obj.Items[i].Futuros+'</span>Eventos Futuros</a>';
				  }
